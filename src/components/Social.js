            ...
            >
              <Stack direction="column" marginBottom={1}>
                <Typography>
                  {" "}
                  <strong>
                    Having difficulties staying on track? Drop your worries
                    below and seek advice from fellow Quitters!{" "}
                  </strong>{" "}
                </Typography>
                <TextField
                  size="small"
                  ...
                  onChange={(event) => {
                    setNewHelp(event.target.value);
                  }}
                />
              </Stack>
              <Button size="small" variant="contained" onClick={createUser}>
                {" "}
                Share
              </Button>
            </Box>
                  ...
                  <div>
                    <Box>
                      ...
                      >
                        <Typography>
                          {" "}
                          <strong>Name: </strong> {user.savior}{" "}
                        </Typography>
                        <Typography>
                          {" "}
                        ...
                        <Button
                          ...
                          size="small"
                          onClick={() => {
                            updateUser(user.id, user.reply, user.savior);
                          }}
                        >
                          {" "}
                          Share{" "}
          ...
          <Stack direction="row" marginTop={4} flexGrow={1}>
            ...
            >
              <TextField
                ...
                placeholder="Name"
                onChange={(event) => {
                  setNewRptname(event.target.value);
                }}
              />
              <Button
                variant="contained"
              ...
              <Typography>
                {" "}
                Spot a Quitter misusing the platform, spreading negativity or
                using abusive language?{" "}
              </Typography>
              <Typography marginBottom={1}>
                {" "}
                Report the fellow user! Lets keep this platform a safe space for
                fellow Quitters to achieve their goal!
              </Typography>
          ...
          >
            <DialogTitle>
              <Alert severity="error">
                {" "}
                <AlertTitle>
                  <strong>Your entry is empty!</strong>{" "}
                </AlertTitle>
              </Alert>
            </DialogTitle>
