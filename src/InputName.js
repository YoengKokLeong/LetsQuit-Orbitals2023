...
import {AppBar, Toolbar, Typography, Button, Stack, Alert, AlertTitle, Dialog, DialogActions, DialogContentText, DialogContent, DialogTitle, Menu, MenuItem} from '@mui/material';
      ...
      <AppBar>
        <Toolbar>
          ...
          <Typography variant="h3" component="div" marginRight={3}>
            ...
            <Button variant = "contained" onClick={handleClick}> <AccountCircleIcon fontSize="medium"/> </Button>
            ...
            <MenuItem onClick={handleNameChangeClick}> Change Name </MenuItem>
